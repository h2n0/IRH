...
public class SandTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		int col = Colour.get(level.sandColor + 2, level.sandColor, level.sandColor - 110, level.sandColor - 110);
		int transitionColor = Colour.get(level.sandColor - 110, level.sandColor, level.sandColor - 110, level.dirtColor);
