...
public class WaterTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		int col = Colour.get(005, 005, 115, 115);
		int transitionColor1 = Colour.get(3, 005, level.dirtColor - 111, level.dirtColor);
		int transitionColor2 = Colour.get(3, 005, level.sandColor - 110, level.sandColor);
