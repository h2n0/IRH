...
public class LavaTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		int col = Colour.get(500, 500, 520, 550);
		int transitionColor1 = Colour.get(3, 500, level.dirtColor - 111, level.dirtColor);
		int transitionColor2 = Colour.get(3, 500, level.sandColor - 110, level.sandColor);
