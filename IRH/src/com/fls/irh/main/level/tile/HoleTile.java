...
public class HoleTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		int col = Colour.get(111, 111, 110, 110);
		int transitionColor1 = Colour.get(3, 111, level.dirtColor - 111, level.dirtColor);
		int transitionColor2 = Colour.get(3, 111, level.sandColor - 110, level.sandColor);
