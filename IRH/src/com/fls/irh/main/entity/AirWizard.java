...
public class AirWizard extends Mob {
	...
	public void render(Screen screen) {
		...
		int col1 = Colour.get(-1, 100, 500, 555);
		int col2 = Colour.get(-1, 100, 500, 532);
		if (health < 200) {
			if (tickTime / 3 % 2 == 0) {
				col1 = Colour.get(-1, 500, 100, 555);
				col2 = Colour.get(-1, 500, 100, 532);
			}
		} else if (health < 1000) {
			if (tickTime / 5 % 4 == 0) {
				col1 = Colour.get(-1, 500, 100, 555);
		...
		if (hurtTime > 0) {
			col1 = Colour.get(-1, 555, 555, 555);
			col2 = Colour.get(-1, 555, 555, 555);
		}
