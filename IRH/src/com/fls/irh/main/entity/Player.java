...
public class Player extends Mob {
	...
	public void render(Screen screen) {
		...
		if (isSwimming()) {
			yo += 4;
			int waterColor = Colour.get(-1, -1, 115, 335);
			if (tickTime / 8 % 2 == 0) {
				waterColor = Colour.get(-1, 335, 5, 115);
			}
		...
		if (attackTime > 0 && attackDir == 1) {
			screen.render(xo + 0, yo - 4, 6 + 13 * 32, Colour.get(-1, 555, 555, 555), 0);
			screen.render(xo + 8, yo - 4, 6 + 13 * 32, Colour.get(-1, 555, 555, 555), 1);
			if (attackItem != null) {
				attackItem.renderIcon(screen, xo + 4, yo - 4);
			}
		}
		int col = Colour.get(-1, 100, 220, 532);
		if (hurtTime > 0) {
			col = Colour.get(-1, 555, 555, 555);
		}
		...
		if (attackTime > 0 && attackDir == 2) {
			screen.render(xo - 4, yo, 7 + 13 * 32, Colour.get(-1, 555, 555, 555), 1);
			screen.render(xo - 4, yo + 8, 7 + 13 * 32, Colour.get(-1, 555, 555, 555), 3);
			if (attackItem != null) {
				attackItem.renderIcon(screen, xo - 4, yo + 4);
			}
		}
		if (attackTime > 0 && attackDir == 3) {
			screen.render(xo + 8 + 4, yo, 7 + 13 * 32, Colour.get(-1, 555, 555, 555), 0);
			screen.render(xo + 8 + 4, yo + 8, 7 + 13 * 32, Colour.get(-1, 555, 555, 555), 2);
			if (attackItem != null) {
				attackItem.renderIcon(screen, xo + 8 + 4, yo + 4);
			}
		}
		if (attackTime > 0 && attackDir == 0) {
			screen.render(xo + 0, yo + 8 + 4, 6 + 13 * 32, Colour.get(-1, 555, 555, 555), 2);
			screen.render(xo + 8, yo + 8 + 4, 6 + 13 * 32, Colour.get(-1, 555, 555, 555), 3);
			if (attackItem != null) {
	...
	protected void doHurt(int damage, int attackDir) {
		...
		level.add(new TextParticle("" + damage, x, y, Colour.get(-1, 504, 504, 504)));
		health -= damage;
